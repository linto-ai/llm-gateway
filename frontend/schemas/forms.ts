...
export const flavorFormSchema = z.object({
  ...
  estimated_cost_per_1k_tokens: z
    .number()
  ...
  placeholder_extraction_prompt_id: z
    .string()
    .uuid("validation.invalidUuid")
    .nullable()
    .optional(),
